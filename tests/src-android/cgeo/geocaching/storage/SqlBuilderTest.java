...
public class SqlBuilderTest {
    ...
    public void simpleOrder() {
        ...
        assertThat(sb.getSql()).isEqualTo("SELECT col1, col2 FROM mytable t ORDER BY col1 asc, col2 desc, (col3) DESC");
    }
    ...
    public void whereAlwaysInclude() {
        ...
        assertThat(sb.getSql()).isEqualTo("SELECT col1, col2 FROM mytable t WHERE (NOT(1=0)) AND (1=1) AND (NOT(NOT(1=1)))");
    }
    ...
    public void limit() {
        final SqlBuilder sb = new SqlBuilder("mytable", new String[]{ "col1", "col2"});
        sb.setLimit(100);
        assertThat(sb.getSql()).isEqualTo("SELECT col1, col2 FROM mytable t LIMIT 100");
    }
    ...
    public void countUnlimited() {
        ...
        sb.setLimit(100);
        assertThat(sb.getSql()).isEqualTo("SELECT col1, col2 FROM mytable t WHERE (col1 = '5') ORDER BY (col1) ASC LIMIT 100");
    ...
    public void complexWhereWithArgs() {
        final SqlBuilder sb = new SqlBuilder("mytable", new String[]{ "col1", "col2"})
            ...
            .openWhere(SqlBuilder.WhereType.NOT).addWhere("x=y").closeWhere()
            .openWhere(SqlBuilder.WhereType.NOT).addWhere("");
        assertThat(sb.getSql()).isEqualTo("SELECT col1, col2 FROM mytable t WHERE (col1=?) AND ((col1=?) OR (col2=?)) AND (NOT(x=y))");
