...
public abstract class MockedCacheAndroid extends Geocache {
    ...
    protected MockedCacheAndroid(final Geopoint coords) {
        this.coords = coords;
        this.data = MockedCacheAndroid.readCachePage(getGeocode());
    ...
    public static String readCachePage(final String geocode) {
        ...
        try {
            is = MockedCacheAndroid.class.getResourceAsStream("/cgeo/geocaching/test/mock/" + geocode + ".html");
