...
public final class GCConstants {
    ...
    public final static Pattern PATTERN_LATLON_PERSONAL = Pattern.compile("___FINAL:(.*?)___");
    public final static Pattern PATTERN_LOCATION = Pattern.compile("<span id=\"ctl00_ContentBody_Location\">In (?:<a href=[^>]*>)(.*?)<");
