 ...
 * Primarily used currently for offline maps and its themes.
 *
 * Workflow "selection":
 * - select a map file (or theme file) using the MapDownloadSelectorActivity
 ...
 *
 * Workflow "update":
 * - press "check update" button in MapDownloadSelectorActivity
