...
public class LambdaExpression<P, R> implements IExpression<LambdaExpression<P, R>> {
    ...
    private final Func3<String[], P, List<R>, R> function;
    private final List<LambdaExpression<P, R>> children = new ArrayList<>();

    private String[] config;

    public static <P, R> LambdaExpression<P, R> createGroup(final String id, final Func3<String[], P, List<R>, R> function) {
    ...
    public static <P, R> LambdaExpression<P, R> createGroupSingleConfig(final String id, final Func3<String, P, List<R>, R> function) {
        return createGroup(id, (sa, p, lr) -> function.call(sa == null || sa.length == 0 ? null : sa[0], p, lr));
    }

    public static <P, R> LambdaExpression<P, R> createValue(final String id, final Func2<String[], P, R> function) {
    ...
    public static <P, R> LambdaExpression<P, R> createValueSingleConfig(final String id, final Func2<String, P, R> function) {
        return createGroup(id, (sa, p, lr) -> function.call(sa == null || sa.length == 0 ? null : sa[0], p));
    }

    private LambdaExpression(final String id, final Func3<String[], P, List<R>, R> function) {
        this.id = id;
    ...
    public String[] getConfig() {
        return config == null ? new String[0] : config;
    }
