...
public class NewMap extends AbstractActionBarActivity {
    ...
    public boolean onPrepareOptionsMenu(final Menu menu) {
        ...
        try {
            ...
            menu.findItem(R.id.menu_store_caches).setVisible(!caches.isDownloading() && caches.getVisibleItemsCount(true) > 0);
        ...
        switch (id) {
            ...
            case R.id.menu_store_caches:
                if (!caches.isDownloading()) {
                    final List<String> geocodes = caches.getVisibleLiveGeocodes();
    ...
    private int countVisibleCaches() {
        return caches != null ? caches.getVisibleItemsCount(false) : 0;
    }
