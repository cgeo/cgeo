 ...
 */
public class WaypointGeneratorDialog extends DialogFragment {
    ...
    public static void show(final FragmentManager mgr, final CoordinateInputData initialState) {
        final WaypointGeneratorDialog ccd = new WaypointGeneratorDialog();
    ...
    public WaypointGeneratorDialog() {
        setCancelable(true);
    }
