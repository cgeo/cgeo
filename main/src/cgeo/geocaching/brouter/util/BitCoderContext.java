...
public class BitCoderContext {
     ...
     * @see #decodeVarBits
     */
    public final void encodeVarBits2(final int valueIn) {
        int value = valueIn;
        int range = 0;
        while (value > range) {
            encodeBit(false);
     ...
     */
    public final void encodeBounded(final int maxIn, final int value) {
        int max = maxIn;
    ...
    public final int decodeBitsReverse(final int countIn) {
        int count = countIn;
        fillBuffer();
        int value = 0;
        while (count > 8) {
