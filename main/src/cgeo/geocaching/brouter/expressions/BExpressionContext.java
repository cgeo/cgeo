...
public abstract class BExpressionContext implements IByteArrayUnifier {
     ...
     * @param hashSizeIn size of hashmap for result caching
     */
    protected BExpressionContext(final String context, final int hashSizeIn, final BExpressionMetaData meta) {
        int hashSize = hashSizeIn;
    ...
    public String getKeyValueDescription(final boolean inverseDirection, final byte[] ab) {
        ...
        for (int inum = 0; inum < lookupValues.size(); inum++) { // loop over lookup names
            ...
            final String value = va[lookupData[inum]].toString();
...
//    if ( histo.length == 500 ) continue;
    ...
    private String variableName(final int idx) {
