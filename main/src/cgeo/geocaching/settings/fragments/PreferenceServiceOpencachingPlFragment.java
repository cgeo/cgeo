...
public class PreferenceServiceOpencachingPlFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        // TODO
        final OCPreferenceKeys key = OCPreferenceKeys.getByAuthId(R.string.pref_fakekey_ocpl_authorization);
        if (key != null) {
            ...
            findPreference(getString(R.string.pref_fakekey_ocpl_authorization)).setSummary(getString(Settings.hasOAuthAuthorization(key.publicTokenPrefId, key.privateTokenPrefId) ? R.string.auth_connected : R.string.auth_unconnected));
        } else {
