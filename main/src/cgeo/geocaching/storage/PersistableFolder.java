...
public enum PersistableFolder {
    ...
    OFFLINE_MAP_SHADING(R.string.pref_persistablefolder_offlinemapshading, R.string.pref_persistablefolder_offlinemapshading, Folder.fromPersistableFolder(OFFLINE_MAPS, "_hgt")),
    /**
