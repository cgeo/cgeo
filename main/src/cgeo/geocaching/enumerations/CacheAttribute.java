...
public enum CacheAttribute {
    ...
    DOGS(CacheAttributeCategory.CAT_SURROUNDINGS, 1, 85, "dogs", R.drawable.attribute_dogs, R.string.attribute_dogs_yes, R.string.attribute_dogs_no),
    ...
    HIKING(CacheAttributeCategory.CAT_TRANSPORT, 9, 21, "hiking", R.drawable.attribute_hiking, R.string.attribute_hiking_yes, R.string.attribute_hiking_no),
    ...
    TICKS(CacheAttributeCategory.CAT_SURROUNDINGS, 19, 64, "ticks", R.drawable.attribute_ticks, R.string.attribute_ticks_yes, R.string.attribute_ticks_no),
    ...
    PARKING(CacheAttributeCategory.CAT_TRANSPORT, 25, 33, "parking", R.drawable.attribute_parking, R.string.attribute_parking_yes, R.string.attribute_parking_no),
    PUBLIC(CacheAttributeCategory.CAT_TRANSPORT, 26, 34, "public", R.drawable.attribute_public, R.string.attribute_public_yes, R.string.attribute_public_no),
    ...
    BICYCLES(CacheAttributeCategory.CAT_TRANSPORT, 32, 27, "bicycles", R.drawable.attribute_bicycles, R.string.attribute_bicycles_yes, R.string.attribute_bicycles_no),
    MOTORCYCLES(CacheAttributeCategory.CAT_TRANSPORT, 33, -1, "motorcycles", R.drawable.attribute_motorcycles, R.string.attribute_motorcycles_yes, R.string.attribute_motorcycles_no),
    QUADS(CacheAttributeCategory.CAT_TRANSPORT, 34, -1, "quads", R.drawable.attribute_quads, R.string.attribute_quads_yes, R.string.attribute_quads_no),
    JEEPS(CacheAttributeCategory.CAT_TRANSPORT, 35, -1, "jeeps", R.drawable.attribute_jeeps, R.string.attribute_jeeps_yes, R.string.attribute_jeeps_no),
    SNOWMOBILES(CacheAttributeCategory.CAT_TRANSPORT, 36, -1, "snowmobiles", R.drawable.attribute_snowmobiles, R.string.attribute_snowmobiles_yes, R.string.attribute_snowmobiles_no),
    HORSES(CacheAttributeCategory.CAT_TRANSPORT, 37, -1, "horses", R.drawable.attribute_horses, R.string.attribute_horses_yes, R.string.attribute_horses_no),
    CAMPFIRES(CacheAttributeCategory.CAT_SURROUNDINGS, 38, -1, "campfires", R.drawable.attribute_campfires, R.string.attribute_campfires_yes, R.string.attribute_campfires_no),
    THORN(CacheAttributeCategory.CAT_SURROUNDINGS, 39, 63, "thorn", R.drawable.attribute_thorn, R.string.attribute_thorn_yes, R.string.attribute_thorn_no),
    ...
    STROLLER(CacheAttributeCategory.CAT_TRANSPORT, 41, -1, "stroller", R.drawable.attribute_stroller, R.string.attribute_stroller_yes, R.string.attribute_stroller_no),
    ...
    RV(CacheAttributeCategory.CAT_TRANSPORT, 46, 86, "rv", R.drawable.attribute_rv, R.string.attribute_rv_yes, R.string.attribute_rv_no),
    ...
    PARTNERSHIP(CacheAttributeCategory.CAT_TOOLS, 61, -1, "partnership", R.drawable.attribute_partnership, R.string.attribute_partnership_yes, R.string.attribute_partnership_no),
    ...
    GEOTOUR(CacheAttributeCategory.CAT_SURROUNDINGS, 67, -1, "geotour", R.drawable.attribute_geotour, R.string.attribute_geotour_yes, R.string.attribute_geotour_no),
    ...
    POWERTRAIL(CacheAttributeCategory.CAT_SURROUNDINGS, 70, -1, "powertrail", R.drawable.attribute_powertrail, R.string.attribute_powertrail_yes, R.string.attribute_powertrail_no),
    ...
    RAILWAY(CacheAttributeCategory.CAT_SURROUNDINGS, -1, 60, "railway", R.drawable.attribute_railway, R.string.attribute_railway_yes, R.string.attribute_railway_no),
    ...
    SWAMP(CacheAttributeCategory.CAT_SURROUNDINGS, -1, 22, "swamp", R.drawable.attribute_swamp, R.string.attribute_swamp_yes, R.string.attribute_swamp_no),
    HILLS(CacheAttributeCategory.CAT_SURROUNDINGS, 127, 23, "hills", R.drawable.attribute_hills, R.string.attribute_hills_yes, R.string.attribute_hills_no),
    EASY_CLIMBING(CacheAttributeCategory.CAT_SURROUNDINGS, -1, 24, "easy_climbing", R.drawable.attribute_easy_climbing, R.string.attribute_easy_climbing_yes, R.string.attribute_easy_climbing_no),
    ...
    AIRCRAFT(CacheAttributeCategory.CAT_TRANSPORT, -1, 75, "aircraft", R.drawable.attribute_aircraft, R.string.attribute_aircraft_yes, R.string.attribute_aircraft_no),
    ...
    ASK_OWNER(CacheAttributeCategory.CAT_SURROUNDINGS, -1, 17, "ask_owner", R.drawable.attribute_ask_owner, R.string.attribute_ask_owner_yes, R.string.attribute_ask_owner_no),
    UNKNOWN(CacheAttributeCategory.CAT_TYPE, -1, -1, "unknown", R.drawable.attribute_unknown, R.string.attribute_unknown_yes, R.string.attribute_unknown_no),
    ...
    MAGNETIC(CacheAttributeCategory.CAT_TOOLS, -1, 6, "magnetic", R.drawable.attribute_magnetic, R.string.attribute_magnetic_yes, R.string.attribute_magnetic_no),
    ...
    PEDESTRIAN_ONLY(CacheAttributeCategory.CAT_LOCATION, -1, 20, "pedestrian_only", R.drawable.attribute_pedestrian_only, R.string.attribute_pedestrian_only_yes, R.string.attribute_pedestrian_only_no),
    ...
    TRACKABLES(CacheAttributeCategory.CAT_LOCATION, -1, 81, "trackables", R.drawable.attribute_trackables, R.string.attribute_trackables_yes, R.string.attribute_trackables_no),
