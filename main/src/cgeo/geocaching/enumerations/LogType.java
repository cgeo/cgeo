...
public enum LogType {
	...
	OWNER_MAINTENANCE(46, "46", "owner maintenance", "", R.string.log_maintained, R.drawable.mark_green_more, R.drawable.marker_maintenance),
	UPDATE_COORDINATES(47, "47", "update coordinates", "Moved", R.string.log_update, R.drawable.marker_maintenance),
