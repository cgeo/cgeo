...
public enum LogType {
    ...
    FOUND_IT(2, "2", "found it", "Found it", R.string.log_found, R.drawable.mark_green, R.drawable.marker_found_offline), DIDNT_FIND_IT(3, "3", "didn't find it", "Didn't find it", R.string.log_dnf, R.drawable.mark_red, R.drawable.marker_not_found_offline), NOTE(4, "4", "write note", "Comment", R.string.log_note, R.drawable.marker_note),
 ...
 NEEDS_MAINTENANCE(45, "45", "needs maintenance", "Needs maintenance", R.string.log_maintenance_needed, R.drawable.mark_red, R.drawable.marker_maintenance), OWNER_MAINTENANCE(46, "46", "owner maintenance", "", R.string.log_maintained, R.drawable.mark_green_more, R.drawable.marker_maintenance), UPDATE_COORDINATES(47, "47", "update coordinates", "Moved", R.string.log_update, R.drawable.marker_maintenance),
 ...
 WEBCAM_PHOTO_TAKEN(11, "11", "webcam photo taken", "", R.string.log_webcam, R.drawable.mark_green, R.drawable.marker_found_offline),
    ...
    LogType(final int id, @Nullable final String iconName, @NonNull final String type, @NonNull final String oc_type, final int stringId, final int markerId, final int overlayId) {
        this.id = id;
