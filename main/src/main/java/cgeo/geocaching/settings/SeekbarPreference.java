...
public class SeekbarPreference extends Preference {
    ...
    public void onBindViewHolder(@NonNull final PreferenceViewHolder holder) {
        ...
        this.seekbarUI = getExtraView(holder);
        if (seekbarUI == null) {
    ...
    private SeekbarUI getExtraView(final PreferenceViewHolder holder) {
        final FrameLayout widget = (FrameLayout) holder.findViewById(R.id.widget_extra);
        if (widget.getChildCount() == 1) {
            final View child = widget.getChildAt(0);
            return child instanceof SeekbarUI ? (SeekbarUI) child : null;
        }
        return null;
    }
