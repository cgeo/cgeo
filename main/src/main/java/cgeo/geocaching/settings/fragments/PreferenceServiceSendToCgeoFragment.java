...
public class PreferenceServiceSendToCgeoFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        final Preference openWebsite = findPreference(LocalizationUtils.getString(R.string.pref_fakekey_sendtocgeo_website));
    ...
    public void onResume() {
        ...
        setPrefClick(this, R.string.pref_fakekey_sendtocgeo_info, () -> ShareUtils.openUrl(activity, LocalizationUtils.getString(R.string.settings_send2cgeo_url)));
    }
}
