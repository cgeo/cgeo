...
public class WherigoPushDialogProvider implements IWherigoDialogProvider {
    ...
    public Dialog createAndShowDialog(final Activity activity, final IWherigoDialogControl control) {
        ...
        translatorDisposables.add(TranslatorUtils.initializeView("PushDialog", activity, WherigoGame.get().getTranslator(),
        ...
        if (this.button1 != null) {
            translatorDisposables.add(WherigoGame.get().getTranslator().addTranslation(this.button1, (tr, t) -> this.button1Translated = t ? tr : null));
        }
        if (this.button2 != null) {
            translatorDisposables.add(WherigoGame.get().getTranslator().addTranslation(this.button2, (tr, t) -> this.button2Translated = t ? tr : null));
        }
