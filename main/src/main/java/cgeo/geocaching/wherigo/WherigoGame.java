...
public class WherigoGame implements UI {
    ...
    private void initializeTranslatorForGame() {
        ...
        final List<EventTable> everything = WherigoThingType.getEverything();
        for (EventTable et : everything) {
            this.translator.addTranslation(et.name, (tr, t) -> et.rawset(WherigoUtils.TRANSLATION_NAME_TAG, t ? tr : null));
        }
    }
