...
public class MapDownloaderHylly extends AbstractMapDownloader {
    ...
    protected String getUpdatePageUrl(final String downloadPageUrl) {
        return LocalizationUtils.getString(R.string.mapserver_hylly_updatecheckurl);
    }
    ...
    public DownloaderUtils.DownloadDescriptor getExtrafile(final Activity activity, final Uri mapUri) {
        ...
        String base = LocalizationUtils.getString(R.string.mapserver_hylly_themes_downloadurl);
