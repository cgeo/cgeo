...
public class RouteOptimizationHelper {
    ...
    public void start(final Context context, final Action1<ArrayList<RouteItem>> updateRoute) {
        ...
        Dialogs.advancedOneTimeMessage(context, OneTimeDialogs.DialogType.ROUTE_OPTIMIZATION, context.getString(R.string.route_optimization), context.getString(R.string.route_optimization_info), true, () -> {
