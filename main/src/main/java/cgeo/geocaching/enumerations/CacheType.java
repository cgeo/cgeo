...
public enum CacheType {
    ...
    CacheType(final String id, final String pattern, final String guid, final int stringId, final int shortStringId, final int iconId, final int markerId, @NonNull final String wptTypeId, final int typeColor) {
        this.id = id;
    ...
    public static int getActionBarColor(final Context context, final CacheType cacheType, final boolean isLightSkin) {
        ...
        if (cacheType != null) {
            ...
            // less saturation
            final float offSet1 = isLightSkin ? -0.02f : -0.07f;
            // darker color
            final float offSet2 = isLightSkin ? -0.15f : -0.13f;
