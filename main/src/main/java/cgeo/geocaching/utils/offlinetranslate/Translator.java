...
public class Translator {
    ...
    public Translator() {
        ...
        modelStateListener = TranslationModelManager.get().registerListener(() -> {
            runOnWorker(this::onModelStateChange);
            return false;
        });
    }
    ...
    public String toConfig() {
        synchronized (mutex) {
            ...
            JsonUtils.setBoolean(node, "allowDownload", this.enabled);
    ...
    private void set(final String srcLng, final String trgLng, final String srcLngDetected, final String detectText, final boolean enabled, final boolean allowDownload) {
        runOnWorker(() -> {
            ...
            final boolean effectiveSrcLngChanged =
                !Objects.equals(this.getEffectiveSourceLanguage(), TranslatorUtils.getEffectiveSourceLanguage(srcLng, this.sourceLanguageDetected));
            ...
            this.detectionText = startRedetect ? detectText : null;
    ...
    private void resetAll() {
        invalidateCurrentGen();
        translations.execute(AndroidRxUtils.computationScheduler, c -> runOnWorker(() ->
    ...
    private void translateAll() {
        ...
        final int cnt = translations.execute(AndroidRxUtils.computationScheduler, c -> runOnWorker(() ->
