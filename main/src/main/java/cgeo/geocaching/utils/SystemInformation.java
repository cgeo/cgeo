...
public final class SystemInformation {
    ...
    public static String getSystemInformation(@NonNull final Context context) {
        ...
        body.append("\n- Routing: ").append(Settings.useInternalRouting() ? "internal" : "external").append(" / BRouter installed: ").append(ProcessUtils.isInstalled(LocalizationUtils.getString(R.string.package_brouter)));
