...
public class ThemeLegendVoluntary implements ThemeLegend {
    ...
    public RenderThemeLegend.LegendCategory[] loadLegend(final MapsforgeThemeHelper.RenderThemeType rtt, final ArrayList<RenderThemeLegend.LegendEntry> entries) {
        final String p = rtt.relPath + "/vol_res/patterns";
        final String s = rtt.relPath + "/vol_res/svg";
        ...
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "rock", R.string.rtl_rock));
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "marsh", R.string.rtl_marsh));
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "nature_reserve_large", R.string.rtl_nature_reserve));
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "nature_reserve_small", R.string.rtl_nature_reserve));
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "beach", R.string.rtl_beach));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "wood-coniferous", R.string.rtl_wood_coniferous));
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "wood-deciduous", R.string.rtl_wood_deciduous));
        entries.add(new RenderThemeLegend.LegendEntry(11, p, "wood-mixed", R.string.rtl_wood_mixed));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "rocks", R.string.rtl_rock));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "castle", R.string.rtl_castle));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "ruins", R.string.rtl_ruin));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "information_board", R.string.rtl_info_board));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "camp_site", R.string.rtl_camp_site));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "caravan_site", R.string.rtl_caravan_site));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "picnic", R.string.rtl_picnic_site));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "parking", R.string.rtl_parking));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "airport", R.string.rtl_airport));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "helipad", R.string.rtl_helipad));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "bank", R.string.rtl_bank));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "bicycle_rental", R.string.rtl_bicycle_rental));
        ...
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "worship_church", R.string.rtl_pow_christian));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "worship_jewish", R.string.rtl_pow_jewish));
        entries.add(new RenderThemeLegend.LegendEntry(41, s, "worship_moslem", R.string.rtl_pow_muslim));
    ...
    public @StringRes
    int getInfoUrl() {
        return R.string.maptheme_legend_voluntary;
    }
