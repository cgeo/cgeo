...
public class Intents {
    ...
    public static final String EXTRA_OWNER_MAP = PREFIX + "owner_map";
    ...
    public static final String ACTION_ELEVATIONCHART_CLOSED = PREFIX_ACTION + "ELEVATIONCHART_CLOSED";
