...
public class LogEntryTest {
    ...
    public void testIsMatchingLog() {
        ...
        assertThat(LogUtils.isMatchingLog(logEntry, logEntryEmpty)).isTrue();
        assertThat(LogUtils.isMatchingLog(logEntry, offlineLogEntry)).isTrue();
        assertThat(LogUtils.isMatchingLog(logEntry, logEntryUser)).isFalse();
        assertThat(LogUtils.isMatchingLog(logEntry, logEntryDate)).isFalse();
    }
