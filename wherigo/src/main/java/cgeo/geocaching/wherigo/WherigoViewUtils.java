...
import cgeo.geocaching.wherigo.databinding.WherigoDialogTitleViewBinding;
import cgeo.geocaching.wherigo.databinding.WherigoMapQuickinfosBinding;
import cgeo.geocaching.wherigo.databinding.WherigolistItemBinding;
...
public final class WherigoViewUtils {
    ...
    public static AlertDialog createFullscreenDialog(@NonNull final Activity activity, @Nullable final CharSequence title, @NonNull final View contentView) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(activity, cgeo.geocaching.R.style.cgeo_fullScreen);
    ...
    public static void showErrorDialog(final Activity activity) {
        ...
        final SimpleDialog dialog = SimpleDialog.of(activity)
                ...
                .setPositiveButton(lastError == null ? TextParam.id(cgeo.geocaching.R.string.ok) : TextParam.id(cgeo.geocaching.R.string.copy));

        if (lastError != null) {
            dialog
                .setNeutralButton(TextParam.id(cgeo.geocaching.R.string.log_clear))
            ...
            model
                ...
                .setDisplayViewMapper(R.layout.wherigolist_item, (p, group, view) -> {
                    ...
                    if (info != null) {
                        ...
                        ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_wherigo).applyTo(binding.icon);
                    }
                }, (p, group) -> {
                    final WherigoCartridgeInfo info = cartridgeInfoMap.get(p.first);
                ...
                .setChoiceMode(SimpleItemListModel.ChoiceMode.SINGLE_PLAIN);
            SimpleDialog.of(activity)
                .setTitle(TextParam.id(cgeo.geocaching.R.string.cache_multiple_wherigo_cartridges_title))
                .setMessage(TextParam.id(cgeo.geocaching.R.string.cache_multiple_wherigo_cartridges_message))
    ...
    public static void fillCartridgeSelectItem(final WherigolistItemBinding binding, final WherigoCartridgeInfo info) {
        ...
        final ImageParam icon = iconData == null ? ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_wherigo) :
