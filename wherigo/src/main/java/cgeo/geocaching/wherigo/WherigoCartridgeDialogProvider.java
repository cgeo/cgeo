...
import cgeo.geocaching.wherigo.databinding.WherigoCartridgeDetailsBinding;
...
public class WherigoCartridgeDialogProvider implements IWherigoDialogProvider {
    ...
    private enum CartridgeAction {
        ...
        DELETE(TextParam.id(cgeo.geocaching.R.string.delete).setAllCaps(true).setImage(ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_delete))),
        CLOSE(TextParam.id(cgeo.geocaching.R.string.close).setAllCaps(true).setImage(ImageParam.id(R.drawable.wherigo_close)));
    ...
    private void refreshGui(final WherigoCartridgeDetailsBinding binding) {
        ...
        TextParam.text("**CGUID:** " + cartridgeInfo.getCGuid() + "  \n" +
            ...
            "**[" + LocalizationUtils.getString(cgeo.geocaching.R.string.cache_menu_browser) + "](" + link + ")**  \n" +
            "**" + LocalizationUtils.getString(cgeo.geocaching.R.string.cache_location) + ":** " + cartridgeInfo.getCartridgeLocation() + "  \n" +
            "**" + LocalizationUtils.getString(cgeo.geocaching.R.string.distance) + ":** " + WherigoUtils.getDisplayableDistance(WherigoLocationProvider.get().getLocation(), cartridgeInfo.getCartridgeLocation())
