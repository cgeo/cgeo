...
public final class WherigoUtils {
    ...
    public static final TextParam TP_OK_BUTTON = TextParam.id(cgeo.geocaching.R.string.ok).setAllCaps(true).setImage(ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_done));
    public static final TextParam TP_CLOSE_BUTTON = TextParam.id(cgeo.geocaching.R.string.close).setAllCaps(true).setImage(ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_done));
    public static final TextParam TP_CANCEL_BUTTON = TextParam.id(cgeo.geocaching.R.string.cancel).setAllCaps(true).setImage(ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_cancel));
    ...
    private static void addDeleteOptions(final Activity activity, final SimpleDialog.ItemSelectModel<WherigoSavegameInfo> model, final String cartridgeName, final Supplier<List<WherigoSavegameInfo>> refresher) {
        model.setItemActionIconMapper(item -> {
                    ...
                    return ImageParam.id(cgeo.geocaching.R.drawable.ic_menu_delete);
                })
    ...
    public static void loadGame(final Activity activity, final WherigoCartridgeInfo cartridgeInfo) {
        ...
        model
            ...
            .setDisplayViewMapper(R.layout.wherigolist_item, (si, group, view) -> {
                ...
                itemBinding.icon.setImageResource(cgeo.geocaching.R.drawable.ic_menu_upload);
    ...
    public static void saveGame(final Activity activity) {
        ...
        model
            ...
            .setDisplayViewMapper(R.layout.wherigolist_item, (si, group, view) -> {
                ...
                itemBinding.name.setText(si.getUserDisplayableName());
                itemBinding.description.setText(si.getUserDisplayableSaveDate());
                itemBinding.icon.setImageResource(cgeo.geocaching.R.drawable.ic_menu_save);
            }, (item, itemGroup) -> item == null ? "" : item.getSavefileName())
            .setChoiceMode(SimpleItemListModel.ChoiceMode.SINGLE_PLAIN);
