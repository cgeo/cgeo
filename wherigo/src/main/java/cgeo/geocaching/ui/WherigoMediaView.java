...
import cgeo.geocaching.wherigo.R;
import cgeo.geocaching.wherigo.WherigoGame;
import cgeo.geocaching.wherigo.databinding.WherigoMediaViewBinding;
...
public class WherigoMediaView extends LinearLayout {
    ...
    private void init(final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
        ...
        final ContextThemeWrapper ctw = new ContextThemeWrapper(getContext(), cgeo.geocaching.R.style.cgeo);
