        ...
        try {
            ...
            stage('Prepare build environment') {
                timeout(5) {
                    ...
                    sh 'rm -fr build build-cache app/build || true'
                    ...
                    sh 'cp /srv/cgeo.geocaching_preferences.xml app/cgeo.geocaching_preferences.xml'
                }
            }
            try {
                timeout(15) {
                ...
                stage ('Cleanup environment') {
                    ...
                    sh '[ -f app/cgeo.geocaching_preferences.xml ] && rm app/cgeo.geocaching_preferences.xml'
                    sh '[ -f app/src/main/res/values/keys.xml ] && rm app/src/main/res/values/keys.xml'
                 }
             }
