...
class ImageUtilsTest {
    ...
    public Unit testBase64decoding() throws IOException {
        ...
        val originalStream: InputStream = CgeoTestUtils.getResourceStream(R.raw.small_file)
        final Byte[] originalImage = Byte[409]
