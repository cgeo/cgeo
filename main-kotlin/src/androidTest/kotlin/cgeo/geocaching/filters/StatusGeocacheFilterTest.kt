...
class StatusGeocacheFilterTest {
    ...
    private Unit singleActiveDisabledArchived(final Boolean cacheDisabled, final Boolean cacheArchived, final Boolean excludeActive, final Boolean excludeDisabled, final Boolean excludeArchived, final Boolean expectedResult) {
    ...
    private Unit singleStandardStatus(final Action2<Geocache, Boolean> cacheSetter, final Action2<StatusGeocacheFilter, Boolean> filterSetter) {
    ...
    private Unit singleStatus(final Action1<Geocache> cacheSetter, final Action1<StatusGeocacheFilter> filterSetter, final Boolean expectedResult) {
