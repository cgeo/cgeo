...
class TextFactoryTest {
    ...
    private static val MY_POSITION: Geopoint = Geopoint(15, -86)
    private static val NORTH_6100M: Geopoint = Geopoint(15.054859, -86)
    private static val WEST_1MILE: Geopoint = Geopoint(15, -86.014984)
    private static val SOUTH_1020M: Geopoint = Geopoint(14.990827, -86)
    private static val EAST_123M: Geopoint = Geopoint(15, -85.998855)
    private static val WEST_34M: Geopoint = Geopoint(15, -86.000317)
    private static val EAST_1M: Geopoint = Geopoint(15, -85.999990)
    private static val EAST_1FT: Geopoint = Geopoint(15, -85.999996)
    ...
    @Test
    public Unit testGetTextSv() {
        setLocale(Locale("sv", "SE"), true)
    ...
    private static Unit setLocale(final Locale locale, final Boolean metric) {
        setLocale(locale, locale, metric)
    }

    private static Unit setLocale(final Locale locale1, final Locale locale2, final Boolean metric) {
