...
class GCConnectorTest  {

    @Test
    public Unit testGetViewport() {

        {
            val viewport: Viewport = Viewport(Geopoint("N 52° 25.369 E 9° 35.499"), Geopoint("N 52° 25.600 E 9° 36.200"))
            val searchResult: SearchResult = ConnectorFactory.searchByViewport(viewport, null)
        ...
        {
            val viewport: Viewport = Viewport(Geopoint("N 51° 36.000 E 7° 50.500"), Geopoint("N 51° 37.350 E7° 51.500"))
            val searchResult: SearchResult = ConnectorFactory.searchByViewport(viewport, null)
            assertThat(searchResult).isNotNull()
            ...
            val viewport2: Viewport = Viewport(Geopoint("N 51° 36.500 E 7° 51.200"), Geopoint("N 51° 36.750 E7° 51.400"))
            val searchResult2: SearchResult = ConnectorFactory.searchByViewport(viewport2, null)
            assertThat(searchResult == (searchResult2))

            // redo search with a way bigger viewport - caching does not help here, so a searchResult should be delivered
            val viewport3: Viewport = Viewport(Geopoint("N 51° 35.000 E 7° 50.000"), Geopoint("N 51° 38.000 E7° 52.000"))
            val searchResult3: SearchResult = ConnectorFactory.searchByViewport(viewport3, null)
            assertThat(!searchResult == (searchResult3))
        }
    }
    ...
    @Test
    public Unit testGeocodeForbiddenChars() {
     ...
     */
    @Test
    public Unit testCanNotHandleTrackablesAnymore() {
    ...
    @Test
    public Unit testGetGeocodeFromText() {
    ...
    @Test
    public Unit testIsChallengeCache() {
