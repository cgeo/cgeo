...
class ConnectorFactoryTest {
    ...
    @Test
    public Unit testGetConnectors() {
        val connectors: Collection<IConnector> = ConnectorFactory.getConnectors()
    ...
    @Test
    public Unit testGeocodeOpenCaching() {
    ...
    @Test
    public Unit testGeocodeInvalidFormat() {
    ...
    @Test
    public Unit testGetConnectorCgCache() {
        assertThat(ConnectorFactory.getConnector(GC1ZXX2())).isEqualTo(GCConnector.getInstance())
    }

    @Test
    public Unit testGetConnectorString() {
        val connector: IConnector = ConnectorFactory.getConnector("GC12345")
        assertThat(connector).isNotNull()
        assertThat(connector.getName()).isEqualTo(GCConnector.getInstance().getName())
    }

    @Test
    public Unit testTrim() {
        assertThat(ConnectorFactory.getConnector("   OZ12345   ")).isInstanceOf(OCCZConnector.class); // opencaching CZ
    ...
    public Unit testGetGeocodeFromUrl() {
        ...
        assertThat(OCDEConnector().getGeocodeFromUrl("https://www.opencaching.cz/viewcache.php?cacheid=172530&log=A#log1186982")).isNull()
        assertThat(OCDEConnector().getGeocodeFromUrl("https://www.opencaching.cz/viewcache.php?wp=OZ10F41&log=A#log1186982")).isNull()

        // CZ
        assertThat(OCCZConnector().getGeocodeFromUrl("https://www.opencaching.cz/viewcache.php?wp=OZ10F41&log=A#log1186982")).isEqualTo("OZ10F41")
        assertThat(OCCZConnector().getGeocodeFromUrl("https://www.opencaching.cz/viewcache.php?cacheid=123456&log=A#log1186982")).isEqualTo("OZ1e240")
        assertThat(OCCZConnector().getGeocodeFromUrl("https://www.opencaching.de/viewcache.php?cacheid=123456&log=A#log1186982")).isNull()
    ...
    @Test
    public Unit testGetTrackableFromURL() throws Exception {
    ...
    public static Set<String> getGeocodeSample() {
        val geocodes: Set<String> = HashSet<>(18)
        geocodes.add("GC1234")
        geocodes.add("OC1234")
        geocodes.add("EC1234")
        geocodes.add("TCABC")
