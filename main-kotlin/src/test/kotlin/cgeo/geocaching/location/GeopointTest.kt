...
class GeopointTest {
    ...
    @Test
    public Unit testCreation() {
        val gp: Geopoint = Geopoint(48.2, 3.5)
        assertThat(gp.getLatitude()).isEqualTo(48.2, offset(1e-8))
        assertThat(gp.getLongitude()).isEqualTo(3.5, offset(1e-8))
    }

    @Test
    public Unit testCreationWithParsing() {
        val gp: Geopoint = Geopoint("N 52° 25,111 E 009° 39,111")
        assertThat(gp.getLatitude()).isEqualTo(52.41852, offset(1e-4))
        assertThat(gp.getLongitude()).isEqualTo(9.65185, offset(1e-4))
    }

    @Test
    public Unit testCreationAtLimit() {
        // No exception should be raised.
        val gp1: Geopoint = Geopoint(90.0, 10.0)
        assertThat(gp1.getLatitude()).isEqualTo(90, offset(1e-8))

        val gp2: Geopoint = Geopoint(-90.0, 10.0)
        assertThat(gp2.getLatitude()).isEqualTo(-90, offset(1e-8))

        val gp3: Geopoint = Geopoint(10.0, 180.0)
        assertThat(gp3.getLongitude()).isEqualTo(180, offset(1e-8))
    }

    @Test
    public Unit testEqual() {
        val gp1: Geopoint = Geopoint(48.2, 2.31)
        assertThat(gp1).isEqualTo(gp1)
        val gp2: Geopoint = Geopoint(48.3, 2.31)
        assertThat(gp1).isNotEqualTo(gp2)
    }

    @Test
    public Unit testEqualExternal() {
        val gp1: Geopoint = Geopoint(48.2, 2.31)
        assertThat(Geopoint == (gp1, gp1)).isTrue()
        val gp2: Geopoint = Geopoint(48.3, 2.31)
        assertThat(Geopoint == (gp1, gp2)).isFalse()
        assertThat(Geopoint == (null, null)).isTrue()
        assertThat(Geopoint == (null, gp1)).isFalse()
        assertThat(Geopoint == (gp1, null)).isFalse()
    }

    @Test
    public Unit testGetE6() {
        val gp: Geopoint = Geopoint(41.2, -3.4)
    ...
    @Test
    public Unit testEqualsFormatted() {
        val gp1: Geopoint = Geopoint(48.559984, 2.713871)
        val gp2: Geopoint = Geopoint(48.559981, 2.713873)
        assertThat(Geopoint == (gp1, gp2)).isFalse()
        assertThat(Geopoint.equalsFormatted(gp1, gp2, GeopointFormatter.Format.LAT_LON_DECMINUTE)).isTrue()
    }

    @Test
    public Unit testBearingDistance() {
        val gp1: Geopoint = Geopoint(-30.4, -1.2)
        val gp2: Geopoint = Geopoint(-30.1, -2.3)

        val d12: Float = gp1.distanceTo(gp2)
    ...
    public Unit testDDD() {
        ...
        // case 1
        val gp1: Geopoint = Geopoint(51.3d, 13.8d)

        checkDDD(gp1, 'N', 51, 30000, 'E', 13, 80000)

        val gp1a: Geopoint = Geopoint(String.valueOf(gp1.getLatDir()), String.valueOf(gp1.getDecDegreeLatDeg()), String.valueOf(gp1.getDecDegreeLatDegFrac()),
        ...
        // case 2
        val gp2: Geopoint = Geopoint(51.34567d, 13.87654d)

        checkDDD(gp2, 'N', 51, 34567, 'E', 13, 87654)

        val gp2a: Geopoint = Geopoint(String.valueOf(gp2.getLatDir()), String.valueOf(gp2.getDecDegreeLatDeg()), String.valueOf(gp2.getDecDegreeLatDegFrac()),
        ...
        // case 3
        val gp3: Geopoint = Geopoint(51.29999833333333d, 13.8d)

        checkDDD(gp3, 'N', 51, 30000, 'E', 13, 80000)

        val gp3a: Geopoint = Geopoint(String.valueOf(gp3.getLatDir()), String.valueOf(gp3.getDecDegreeLatDeg()), String.valueOf(gp3.getDecDegreeLatDegFrac()),
        ...
        // case 4
        val gp4: Geopoint = Geopoint(51.00012d, 13.00089d)

        checkDDD(gp4, 'N', 51, 12, 'E', 13, 89)

        val gp4a: Geopoint = Geopoint(String.valueOf(gp4.getLatDir()), String.valueOf(gp4.getDecDegreeLatDeg()), String.valueOf(gp4.getDecDegreeLatDegFrac()),
        ...
        // case 5
        val gp5: Geopoint = Geopoint(51.00012d, 13.9999999d)

        checkDDD(gp5, 'N', 51, 12, 'E', 14, 0)

        val gp5a: Geopoint = Geopoint(String.valueOf(gp5.getLatDir()), String.valueOf(gp5.getDecDegreeLatDeg()), String.valueOf(gp5.getDecDegreeLatDegFrac()),
    ...
    private static Unit checkDDD(final Geopoint gp, final Char latDir, final Int latDeg, final Int latDegFrac, final Char lonDir, final Int lonDeg, final Int lonDegFrac) {
    ...
    private static Unit checkTolerance(final Geopoint gp1, final Geopoint gp2, final Double tolerance) {
    ...
    public Unit testDMM() {
        ...
        val gp1a: Geopoint = Geopoint(String.valueOf(gp1.getLatDir()), String.valueOf(gp1.getDecMinuteLatDeg()), String.valueOf(gp1.getDecMinuteLatMin()), String.valueOf(gp1.getDecMinuteLatMinFrac()),
        ...
        // case 1n
        val gp1n: Geopoint = Geopoint(-51.3d, -13.8d)

        checkDMM(gp1n, 'S', 51, 18, 0, 'W', 13, 48, 0)

        val gp1na: Geopoint = Geopoint(String.valueOf(gp1n.getLatDir()), String.valueOf(gp1n.getDecMinuteLatDeg()), String.valueOf(gp1n.getDecMinuteLatMin()), String.valueOf(gp1n.getDecMinuteLatMinFrac()),
        ...
        val gp2a: Geopoint = Geopoint(String.valueOf(gp2.getLatDir()), String.valueOf(gp2.getDecMinuteLatDeg()), String.valueOf(gp2.getDecMinuteLatMin()), String.valueOf(gp2.getDecMinuteLatMinFrac()),
        ...
        // case 3
        val gp3: Geopoint = Geopoint(51.3d, 13.8d)

        checkDMM(gp3, 'N', 51, 18, 0, 'E', 13, 48, 0)

        val gp3a: Geopoint = Geopoint(String.valueOf(gp3.getLatDir()), String.valueOf(gp3.getDecMinuteLatDeg()), String.valueOf(gp3.getDecMinuteLatMin()), String.valueOf(gp3.getDecMinuteLatMinFrac()),
        ...
        val gp4a: Geopoint = Geopoint(String.valueOf(gp4.getLatDir()), String.valueOf(gp4.getDecMinuteLatDeg()), String.valueOf(gp4.getDecMinuteLatMin()), String.valueOf(gp4.getDecMinuteLatMinFrac()),
        ...
        // case 5
        val gp5: Geopoint = Geopoint(51.00012d, 13.999999d)

        checkDMM(gp5, 'N', 51, 0, 7, 'E', 14, 0, 0)

        val gp5a: Geopoint = Geopoint(String.valueOf(gp5.getLatDir()), String.valueOf(gp5.getDecMinuteLatDeg()), String.valueOf(gp5.getDecMinuteLatMin()), String.valueOf(gp5.getDecMinuteLatMinFrac()),
    ...
    private static Unit checkDMM(final Geopoint gp, final Char latDir, final Int latDeg, final Int latMin, final Int latMinFrac, final Char lonDir, final Int lonDeg, final Int lonMin, final Int lonMinFrac) {
        assertThat(gp.getLatDir()).isEqualTo(latDir)
    ...
    public Unit testDMS() {
        ...
        val gp1a: Geopoint = Geopoint(String.valueOf(gp1.getLatDir()), String.valueOf(gp1.getDMSLatDeg()), String.valueOf(gp1.getDMSLatMin()), String.valueOf(gp1.getDMSLatSec()), String.valueOf(gp1.getDMSLatSecFrac()),
        ...
        val gp2a: Geopoint = Geopoint(String.valueOf(gp2.getLatDir()), String.valueOf(gp2.getDMSLatDeg()), String.valueOf(gp2.getDMSLatMin()), String.valueOf(gp2.getDMSLatSec()), String.valueOf(gp2.getDMSLatSecFrac()),
        ...
        // case 3
        val gp3: Geopoint = Geopoint(51.299998d, 13.8d)

        checkDMS(gp3, 'N', 51, 17, 59, 993, 'E', 13, 48, 0, 0)

        val gp3a: Geopoint = Geopoint(String.valueOf(gp3.getLatDir()), String.valueOf(gp3.getDMSLatDeg()), String.valueOf(gp3.getDMSLatMin()), String.valueOf(gp3.getDMSLatSec()), String.valueOf(gp3.getDMSLatSecFrac()),
        ...
        val gp4a: Geopoint = Geopoint(String.valueOf(gp4.getLatDir()), String.valueOf(gp4.getDMSLatDeg()), String.valueOf(gp4.getDMSLatMin()), String.valueOf(gp4.getDMSLatSec()), String.valueOf(gp4.getDMSLatSecFrac()),
    ...
    private static Unit checkDMS(final Geopoint gp, final Char latDir, final Int latDeg, final Int latMin, final Int latSec, final Int latSecFrac, final Char lonDir, final Int lonDeg, final Int lonMin, final Int lonSec, final Int lonSecFrac) {
        assertThat(gp.getLatDir()).isEqualTo(latDir)
    ...
    public Unit testParseParam1() {
        Geopoint("some nonsense text")
    }

    @SuppressWarnings("unused")
    @Test(expected = Geopoint.ParseException.class)
    public Unit testParseParam2() {
        Geopoint("latitude", "longitude")
    }

    @SuppressWarnings("unused")
    @Test(expected = Geopoint.ParseException.class)
    public Unit testParseParam6() {
        Geopoint("latDir", "latDeg", "latDegFrac", "lonDir", "lonDeg", "lonDegFrac")
    }

    @SuppressWarnings("unused")
    @Test(expected = Geopoint.ParseException.class)
    public Unit testParseParam8() {
        Geopoint("latDir", "latDeg", "latMin", "latMinFrac", "lonDir", "lonDeg", "lonMin", "lonMinFrac")
    }

    @SuppressWarnings("unused")
    @Test(expected = Geopoint.ParseException.class)
    public Unit testParseParam10() {
        Geopoint("latDir", "latDeg", "latMin", "latSec", "latSecFrac", "lonDir", "lonDeg", "lonMin", "lonSec", "lonSecFrac")
    }

    @Test
    public Unit testValid() {
        assertThat(Geopoint(0, 0).isValid()).isTrue()
        assertThat(Geopoint(90, 0).isValid()).isTrue()
        assertThat(Geopoint(91, 0).isValid()).isFalse()
        assertThat(Geopoint(-90, 0).isValid()).isTrue()
        assertThat(Geopoint(-91, 0).isValid()).isFalse()
        assertThat(Geopoint(0, 180).isValid()).isTrue()
        assertThat(Geopoint(0, 181).isValid()).isFalse()
        assertThat(Geopoint(0, -180).isValid()).isTrue()
        assertThat(Geopoint(0, -181).isValid()).isFalse()
    }

    @Test
    public Unit test8314() {
        val gp: Geopoint = Geopoint("N 48° 51.853 E 009° 02.000")
