...
import cgeo.geocaching.location.UTMPoint.latLong2UTM
...
class UTMPointConversionTest {
    ...
    @Test
    public Unit testLatLong2UTM() throws Exception {
        val utm: UTMPoint = latLong2UTM(Geopoint(this.lat, this.lon))
    ...
    @Test
    public Unit testUTM2LatLong() throws Exception {
        val gp: Geopoint = UTMPoint(this.zone, this.zoneLetter.charAt(0), this.easting, this.northing).toLatLong()
