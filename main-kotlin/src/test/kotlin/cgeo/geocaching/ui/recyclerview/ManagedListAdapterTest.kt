...
class ManagedListAdapterTest {

    public static class TestHolder : RecyclerView().ViewHolder {
    ...
    public static class TestManagedListAdapter : ManagedListAdapter()<String, TestHolder> {

        protected TestManagedListAdapter() {
            super(Config(null).setNotifyOnEvents(false))
        }

        override         public TestHolder onCreateViewHolder(final ViewGroup parent, final Int viewType) {
            return TestHolder(parent)
        }

        override         public Unit onBindViewHolder(final TestHolder holder, final Int position) {
            //empty on purpose
        }
    }

    @Test
    public Unit simpleAddRemove() {
        val mla: TestManagedListAdapter = TestManagedListAdapter()
