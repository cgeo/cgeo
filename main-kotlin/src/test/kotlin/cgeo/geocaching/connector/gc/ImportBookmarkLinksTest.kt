...
class ImportBookmarkLinksTest {

    val intentUrlParser: UrlToIdParser = ImportBookmarkLinks.defaultBookmarkListUrlToIdParser()
    ...
    public static Collection<Object[]> testData() {
        ...
        val testData: ArrayList<Object[]> = ArrayList<>()
    ...
    @Test
    public Unit testUrls() {
        val testUrl: String = composeUsing(
                protocol,
                hostAndPath,
                bookmarkListId,
                suffix
        )
        val fromIntentUrl: Optional<String> = intentUrlParser.tryExtractFromIntentUrl(testUrl)
