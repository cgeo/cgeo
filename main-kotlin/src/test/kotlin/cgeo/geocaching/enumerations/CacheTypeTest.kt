...
class CacheTypeTest {
    ...
    @Test
    public Unit testGetByPatternComplete() {
        for (final CacheType type : CacheType.values()) {
    ...
    @Test
    public Unit testContainsCache() {
        val traditional: Geocache = Geocache()
    ...
    @Test
    public Unit testEventCacheTypes() throws Exception {
