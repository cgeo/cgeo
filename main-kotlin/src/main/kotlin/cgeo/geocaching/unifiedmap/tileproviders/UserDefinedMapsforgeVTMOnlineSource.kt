...
class UserDefinedMapsforgeVTMOnlineSource : AbstractMapsforgeVTMOnlineTileProvider() {
    UserDefinedMapsforgeVTMOnlineSource() {
        super(CgeoApplication.getInstance().getString(R.string.settings_userDefinedTileProvider), Uri.parse(Settings.getUserDefinedTileProviderUri()), "/{Z}/{X}/{Y}.png", MIN_ZOOM_LEVEL, 18, Pair<>(CgeoApplication.getInstance().getString(R.string.settings_userDefinedTileProvider), true))
