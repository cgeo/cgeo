 ...
 */
class MapsforgeThemeHelper : XmlRenderThemeMenuCallback {
    ...
    public Unit reapplyMapTheme(final TileLayer rendererLayer, final TileCache tileCache) {
        if (!(rendererLayer is TileRendererLayer)) {
            return
        }
    ...
    public Unit selectMapTheme(final TileLayer tileLayer, final TileCache tileCache) {
    ...
    public Unit selectMapThemeOptions() {
        val intent: Intent = Intent(activity, MapsforgeThemeSettings.class)
