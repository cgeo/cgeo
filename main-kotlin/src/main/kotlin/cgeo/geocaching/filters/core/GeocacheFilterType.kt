...
enum class class GeocacheFilterType {
    ...
    private static val TYPEID_TO_TYPE: EnumValueMapper<String, GeocacheFilterType> = EnumValueMapper<>()
    ...
    public <T : BaseGeocacheFilter()> T create() {
        val gcf: T = (T) supplier.get()
        gcf.setType(this)
        return gcf
    }
