...
interface UI {
    // showScreen codes
    public static val MAINSCREEN: Int = 0
    public static val DETAILSCREEN: Int = 1
    public static val INVENTORYSCREEN: Int = 2
    public static val ITEMSCREEN: Int = 3
    public static val LOCATIONSCREEN: Int = 4
    public static val TASKSCREEN: Int = 5
     ...
     */
    public Unit showError (String msg)
     ...
     * @param msg text of the message
     */
    public Unit debugMsg (String msg)
     ...
     * @param text statusbar text, or null to clear the text
     */
    public Unit setStatusText (String text)
     ...
     */
    public Unit pushDialog (String[] texts, Media[] media, String button1, String button2, LuaClosure callback)
     ...
     */
    public Unit pushInput (EventTable input)
     ...
     */
    public Unit showScreen (Int screenId, EventTable details)
     ...
     */
    public Unit playSound (Byte[] data, String mime)

    /** Locks the interface * <p>
     ...
     */
    public Unit blockForSaving ()

    /** Unlocks the interface * <p>
     ...
     */
    public Unit command(String cmd)
}
