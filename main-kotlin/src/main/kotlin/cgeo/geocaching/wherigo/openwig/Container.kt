...
class Container : EventTable() {

    var inventory: LuaTable = LuaTableImpl()
    var container: Container = null

    private static JavaFunction moveTo = JavaFunction() {
    ...
    private static JavaFunction contains = JavaFunction() {
        public Int call (LuaCallFrame callFrame, Int nArguments) {
    ...
    public Object rawget (Object key) {
        if ("Container" == (key)) return container
    ...
    throws IOException {
        ...
        if (o is Container) container = (Container)o
        else container = null
    }
}
