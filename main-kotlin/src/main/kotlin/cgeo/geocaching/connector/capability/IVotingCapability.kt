 ...
 */
interface IVotingCapability : IConnector() {
     ...
     */
    Boolean canVote(Geocache cache, LogType logType)

    /**
     * Indicates whether voting is possible for this cache in general
     */
    Boolean supportsVoting(Geocache cache)
     ...
     */
    @WorkerThread
    Boolean postVote(Geocache cache, Float rating)
