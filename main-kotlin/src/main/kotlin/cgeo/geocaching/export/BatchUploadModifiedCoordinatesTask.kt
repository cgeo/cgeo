...
class BatchUploadModifiedCoordinatesTask : AsyncTaskWithProgress()<Geocache, Boolean> {
    /**
    ...
    private var uploadOk: Int = 0
    private var uploadFailed: Int = 0

    BatchUploadModifiedCoordinatesTask(final Activity activity, final String title, final Boolean modifiedOnly) {
