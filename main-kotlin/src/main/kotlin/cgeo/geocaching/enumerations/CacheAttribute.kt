...
enum class class CacheAttribute {
    ...
    FEE(CacheAttributeCategory.CAT_LOCATION, 2, 26, "fee", R.drawable.attribute_fee, R.string.attribute_fee_yes, 0),
    RAPPELLING(CacheAttributeCategory.CAT_TOOLS, 3, 53, "rappelling", R.drawable.attribute_rappelling, R.string.attribute_rappelling_yes, 0),
    BOAT(CacheAttributeCategory.CAT_TOOLS, 4, 57, "boat", R.drawable.attribute_boat, R.string.attribute_boat_yes, 0),
    SCUBA(CacheAttributeCategory.CAT_TOOLS, 5, 55, "scuba", R.drawable.attribute_scuba, R.string.attribute_scuba_yes, 0),
    ...
    WADING(CacheAttributeCategory.CAT_TOOLS, 11, -1, "wading", R.drawable.attribute_wading, R.string.attribute_wading_yes, 0),
    SWIMMING(CacheAttributeCategory.CAT_TOOLS, 12, 25, "swimming", R.drawable.attribute_swimming, R.string.attribute_swimming_yes, 0),
    ...
    MINE(CacheAttributeCategory.CAT_LOCATION, 20, 65, "mine", R.drawable.attribute_mine, R.string.attribute_mine_yes, 0),
    CLIFF(CacheAttributeCategory.CAT_LOCATION, 21, 61, "cliff", R.drawable.attribute_cliff, R.string.attribute_cliff_yes, 0),
    HUNTING(CacheAttributeCategory.CAT_LOCATION, 22, 62, "hunting", R.drawable.attribute_hunting, R.string.attribute_hunting_yes, 0),
    DANGER(CacheAttributeCategory.CAT_LOCATION, 23, 59, "danger", R.drawable.attribute_danger, R.string.attribute_danger_yes, 0),
    ...
    PUBLIC(CacheAttributeCategory.CAT_SURROUNDINGS, 26, 34, "public", R.drawable.attribute_public, R.string.attribute_public_yes, 0),
    ...
    THORN(CacheAttributeCategory.CAT_LOCATION, 39, 63, "thorn", R.drawable.attribute_thorn, R.string.attribute_thorn_yes, 0),
    ...
    FIRSTAID(CacheAttributeCategory.CAT_STATUS, 42, -1, "firstaid", R.drawable.attribute_firstaid, R.string.attribute_firstaid_yes, 0),
    COW(CacheAttributeCategory.CAT_SURROUNDINGS, 43, -1, "cow", R.drawable.attribute_cow, R.string.attribute_cow_yes, 0),
    FLASHLIGHT(CacheAttributeCategory.CAT_TOOLS, 44, 52, "flashlight", R.drawable.attribute_flashlight, R.string.attribute_flashlight_yes, 0),
    ...
    UV(CacheAttributeCategory.CAT_TOOLS, 48, 83, "uv", R.drawable.attribute_uv, R.string.attribute_uv_yes, 0),
    SNOWSHOES(CacheAttributeCategory.CAT_TOOLS, 49, -1, "snowshoes", R.drawable.attribute_snowshoes, R.string.attribute_snowshoes_yes, 0),
    SKIIS(CacheAttributeCategory.CAT_TOOLS, 50, -1, "skiis", R.drawable.attribute_skiis, R.string.attribute_skiis_yes, 0),
    S_TOOL(CacheAttributeCategory.CAT_TOOLS, 51, 56, "s_tool", R.drawable.attribute_s_tool, R.string.attribute_s_tool_yes, 0),
    ...
    WIRELESSBEACON(CacheAttributeCategory.CAT_TOOLS, 60, 9, "wirelessbeacon", R.drawable.attribute_wirelessbeacon, R.string.attribute_wirelessbeacon_yes, 0),
    ...
    BONUSCACHE(CacheAttributeCategory.CAT_TYPE, 69, -1, "bonuscache", R.drawable.attribute_bonuscache, R.string.attribute_bonuscache_yes, 0),
    POWERTRAIL(CacheAttributeCategory.CAT_TYPE, 70, -1, "powertrail", R.drawable.attribute_powertrail, R.string.attribute_powertrail_yes, 0),
    CHALLENGECACHE(CacheAttributeCategory.CAT_TYPE, 71, -1, "challengecache", R.drawable.attribute_challengecache, R.string.attribute_challengecache_yes, 0),
    HQSOLUTIONCHECKER(CacheAttributeCategory.CAT_TYPE, 72, -1, "hqsolutionchecker", R.drawable.attribute_hqsolutionchecker, R.string.attribute_hqsolutionchecker_yes, 0),
    ...
    private static val INTERNAL_YES: String = "_yes"
    private static val INTERNAL_NO: String = "_no"

    public static val NO_ID: Int = -1
    ...
    CacheAttribute(final CacheAttributeCategory category, final Int gcid, final Int ocacode, final String rawName,
    ...
    private static val FIND_BY_GCRAWNAME: Map<String, CacheAttribute> = HashMap<>()
    private static val FIND_BY_GCNAME: Map<String, CacheAttribute> = HashMap<>()
    private static val FIND_BY_ID: SparseArray<CacheAttribute> = SparseArray<>()
    private static val FIND_BY_OCACODE: SparseArray<CacheAttribute> = SparseArray<>()
     ...
     */
    public static CacheAttribute getByName(final String rawName) {
    ...
    public static List<CacheAttribute> getByCategory(final CacheAttributeCategory category) {
        val attributes: List<CacheAttribute> = ArrayList<>()
    ...
    public static Boolean hasRecognizedAttributeIcon(final List<String> attributes) {
    ...
    public static List<CacheAttribute> getAttributesByCategoryAndConnector(final CacheAttributeCategory cac, final Int sources) {
        val showGc: Boolean = AttributesFilterViewHolder.isAttributeFilterSourcesGC(sources)
        val showOc: Boolean = AttributesFilterViewHolder.isAttributeFilterSourcesOkapi(sources)

        val filteredAttributes: List<CacheAttribute> = ArrayList<>()
