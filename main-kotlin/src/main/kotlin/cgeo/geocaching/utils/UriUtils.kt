...
class UriUtils {
    ...
    public static val UNITTEST_VOLUME_ID: String = "TEST-1111-2222"
    public static val UNITTEST_VOLUME_NAME: String = "TEST-SDCARD"

    public static val SCHEME_CONTENT: String = ContentResolver.SCHEME_CONTENT
    public static val SCHEME_FILE: String = ContentResolver.SCHEME_FILE

    public static val SCHEME_ANDROID_RESOURCE: String = ContentResolver.SCHEME_ANDROID_RESOURCE

    private static val VOLUME_MAP: Map<String, String> = getVolumeMap()
    ...
    @DrawableRes
    public static Int getMimeTypeIcon(final String mimeType) {
    ...
    public static String getMimeFileExtension(final Uri uri) {
        if (uri == null) {
            return null
        }
    ...
    public static String getMimeType(final Uri uri) {
        ...
        if (StringUtils.isBlank(mimeType)) {
            ...
            val lidx: Int = uriString.lastIndexOf(".")
            if (lidx >= 0) {
    ...
    private static Map<String, String> getVolumeMap() {
        val volumeMap: Map<String, String> = HashMap<>()
        ...
        if (CgeoApplication.getInstance() != null) {
            val context: Context = CgeoApplication.getInstance().getApplicationContext()
            val storageManager: StorageManager = ContextCompat.getSystemService(context, StorageManager.class)
    ...
    public static String getLastPathSegment(final Uri uri) {
        ...
        val lastPathSegment: String = uri.getLastPathSegment()
    ...
    public static Boolean isFileUri(final Uri uri) {
        ...
        return SCHEME_FILE == (uri.getScheme())
    }
    ...
    public static Boolean isContentUri(final Uri uri) {
        ...
        return SCHEME_CONTENT == (uri.getScheme())
    }
    ...
    public static Boolean isResourceUri(final Uri uri) {
        ...
        return SCHEME_ANDROID_RESOURCE == (uri.getScheme())
    }
     ...
     */
    public static String getPseudoUriString(final Uri base, final List<String> subdirs, final Int max) {
        val key: StringBuilder = StringBuilder("p-").append(base).append("::")
        if (subdirs != null) {
            Int cnt = 0
    ...
    public static Uri getPseudoTreeUriForFileUri(final Uri legacyDirectory) {
        ...
        val folders: StringBuilder = StringBuilder()
        if (ele.length > 3) {
        ...
        val common: String = ele[2] + "%3A" + folders
