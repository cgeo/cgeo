...
class PreferenceServiceOpencachingRoFragment : PreferenceFragmentCompat() {
    override     public Unit onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        val openWebsite: Preference = findPreference(getString(R.string.pref_fakekey_ocro_website))
        val urlOrHost: String = OCPreferenceKeys.OC_RO.authParams.host
    ...
    override     public Unit onResume() {
        super.onResume()
        requireActivity().setTitle(R.string.init_oc_ro)
