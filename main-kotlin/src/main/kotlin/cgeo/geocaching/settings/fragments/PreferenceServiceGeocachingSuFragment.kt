...
class PreferenceServiceGeocachingSuFragment : PreferenceFragmentCompat() {
    override     public Unit onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        val openWebsite: Preference = findPreference(getString(R.string.pref_fakekey_su_website))
        val urlOrHost: String = SuConnector.getInstance().getHost()
