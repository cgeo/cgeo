...
class PreferenceServiceOpencachingDeFragment : PreferenceFragmentCompat() {
    override     public Unit onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        val openWebsite: Preference = findPreference(getString(R.string.pref_fakekey_ocde_website))
        val urlOrHost: String = OCPreferenceKeys.OC_DE.authParams.host
    ...
    override     public Unit onResume() {
        super.onResume()
        requireActivity().setTitle(R.string.init_oc)
