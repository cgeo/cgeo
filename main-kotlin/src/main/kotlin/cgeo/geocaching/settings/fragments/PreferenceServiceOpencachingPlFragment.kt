...
class PreferenceServiceOpencachingPlFragment : PreferenceFragmentCompat() {
    override     public Unit onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        val openWebsite: Preference = findPreference(getString(R.string.pref_fakekey_ocpl_website))
        val urlOrHost: String = OCPreferenceKeys.OC_PL.authParams.host
    ...
    override     public Unit onResume() {
        super.onResume()
        requireActivity().setTitle(R.string.init_oc_pl)

        // Update authentication preference
        SettingsUtils.updateOpenCachingAuthPreference(this, R.string.pref_fakekey_ocpl_authorization)
    }
}
